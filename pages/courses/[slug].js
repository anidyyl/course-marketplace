      ...
      { courseState &&
        ...
        { courseState === "purchased" && 
          <Message type="warning">
            ...
            <i className="block font-normal">In case of any questions, please contact...</i>
          </Message>
        }
        ...
        { courseState === "deactivated" && 
          <Message type="danger">
            ...
            The funcionality to watch the course has been temporary disabled.
            <i className="block font-normal">Please contact...</i>
          </Message>
        }
        </div>
      }
